...
export function getAspectRatio(dataURL) {
...
export async function generatePDF(companyData, tripInformation, passengers) {
  ...
  // Use jsPDF's html() method to generate the PDF from the HTML content
